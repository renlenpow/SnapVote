...
$p->add_value("1", "ljklkjjlk");	
$p->add_value("2", "ljklk");
$p->add_value("3", "jlk");
$p->add_value("4", "lkj");
$p->add_value("5", "ljk");
$VALID_POLLS["1236867677"] = $p;
$p = new Poll;
$p->question = "whatever";	
$p->returnToURL = "../example.php";				
$p->legend = "This is a Poll";						
...
$p->add_value("4", "kjlk");
$p->add_value("5", "jk");
$VALID_POLLS["1238092318"] = $p;
$p = new Poll;
$p->question = "Which is Better?";	
$p->returnToURL = "../example.php";				
$p->legend = "This is a Poll";						
$p->control_type = $CONTROL_RADIOBUTTONS;		
$p->add_value("1", "iPhone");	
$p->add_value("2", "Android");
$p->add_value("3", "BlackBerry");
$p->add_value("4", "");
$p->add_value("5", "");
$VALID_POLLS["iPhone"] = $p;
